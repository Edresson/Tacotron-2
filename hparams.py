...
hparams = tf.contrib.training.HParams(
	...
	tacotron_synthesis_batch_size = 16*16 , #This ensures GTA synthesis goes up to 40x faster than one sample at a time and uses 100% of your GPU computation power.
