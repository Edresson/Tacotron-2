...
hparams = tf.contrib.training.HParams(
	...
	max_mel_frames = 740,  #Only relevant when clip_mels_length = True
	...
	tacotron_batch_size = 5, #number of training samples on each training steps
	...
	tacotron_zoneout_rate = 0.7, #zoneout rate for all LSTM cells in the network
	tacotron_dropout_rate = 0.9, #dropout rate for all convolutional layers + prenet
